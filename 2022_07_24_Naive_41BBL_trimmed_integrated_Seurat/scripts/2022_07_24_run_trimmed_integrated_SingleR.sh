...
--job-name=2022_07_24_Naive_41BBL_trimmed_integrated_SingleR \
--output=log_2022_07_24_Naive_41BBL_trimmed_integrated_SingleR_%j.out \
...
Rscript 2022_07_24_Naive_41BBL_trimmed_integrated_SingleR.R"
