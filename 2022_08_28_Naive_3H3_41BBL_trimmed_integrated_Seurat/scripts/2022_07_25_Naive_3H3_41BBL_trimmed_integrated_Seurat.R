...
folder_path = file.path("../../2022_07_21_Naive_3H3_41BBL_scRNAseq/output/cellranger_aggr_trimmed")
...
for(i in 1:length(directories)) {
  dat_list <- create_data_list(dat_list, directories[i], file.path(folder_path, directories[i], "outs", "count", "filtered_feature_bc_matrix"))
}
